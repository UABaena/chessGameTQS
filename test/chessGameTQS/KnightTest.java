...
public class KnightTest {
	...
	void testPossiblesMovements() {
		...
		Square expectedSq3 = board.getSquare(3, 3);
		Square expectedSq4 = board.getSquare(4, 4);
		Square expectedSq5 = board.getSquare(0, 6);
		Square expectedSq6 = board.getSquare(4, 6);
		Square expectedSq7 = board.getSquare(1, 7);
		Square expectedSq8 = board.getSquare(3, 7);
		...
		Square sq4 = new Square(new Pawn(board.PLAYER_2), 0, 6);
		board.setSquare(sq4);
